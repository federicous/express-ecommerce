...
let ElementModel = require('../../../schema/facturaProveedor')
	...
	async save(element) {
		try {
			if (Array.isArray(element)) {
				...
				let verificarExistente = await ElementModel.find({code: `${element.code}`}) // VERIFICO contra el de facturas que exista el código
